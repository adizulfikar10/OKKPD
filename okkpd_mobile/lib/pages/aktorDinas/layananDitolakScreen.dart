...
class LayananDitolakWidget extends StatefulWidget {
  @override
  _LayananDitolakWidgetState createState() => _LayananDitolakWidgetState();
}

class _LayananDitolakWidgetState extends State<LayananDitolakWidget> {
  List listLayanan = [];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: FunctionDart.setAppBar("Layanan Ditolak"),
      body: Column(
        children: <Widget>[
